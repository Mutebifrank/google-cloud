    ...
    <div class="container">
        ...
        <?php
            ...
            if (isset($_POST['upload'])) {
                ...
                $stmt->execute();
                $storage->uploadObject('flylandexpress', $_FILES['file']['name'], $_FILES['file']['tmp_name']);
            }

            /*List objects under a bucket*/
            $storage->listObjects('flylandexpress');

            /*Delete an object*/
            //$storage->deleteObject('flylandexpress', '02.png');

            /*Delete a bucket*/
            //$storage->deleteBucket('sahani');

            /*Download file*/
            //$storage->downloadObject('flylandexpress', 'notes.txt', "D:\\tutorials\\notes_new.txt");

            /*Edit a file*/
           $str =  file_get_contents('gs://flylandexpress/file.txt');
           echo "<pre>";
           echo $str;
           file_put_contents('gs://flylandexpress/file.txt', "flylandexpress")

        //$ImageUrl = $storage->getImageUrl(bucketName: 'flylandexpress', objectName: 'google.png');
        ?>
